...
option(INTERFACE_ENABLE_CAN_SCRIPT "Enable CAN scripting engine"                   ON)
...
# CAN Script requires CAN + CAN HAL
if(INTERFACE_ENABLE_CAN_SCRIPT AND NOT INTERFACE_ENABLE_CAN)
    message(STATUS "INTERFACE_ENABLE_CAN_SCRIPT requires INTERFACE_ENABLE_CAN — enabling CAN")
    set(INTERFACE_ENABLE_CAN ON CACHE BOOL "" FORCE)
endif()
if(INTERFACE_ENABLE_CAN_SCRIPT AND NOT INTERFACE_ENABLE_CAN_HAL)
    message(STATUS "INTERFACE_ENABLE_CAN_SCRIPT requires INTERFACE_ENABLE_CAN_HAL — enabling CAN_HAL")
    set(INTERFACE_ENABLE_CAN_HAL ON CACHE BOOL "" FORCE)
endif()
...
message(STATUS "  CAN script:     ${INTERFACE_ENABLE_CAN_SCRIPT}")
